    ...
    <main className="flex flex-col items-center justify-center bg-black" style={{ height: 'calc(100vh - 5rem)' }}>
      ...
      <style jsx>{`
        ...
        .icon-spiral-bg-light {
          ...
          /* Invert filter for dark mode effect */
        ...
        /* Animation for the eclipse effect - different speeds */
        ...
        .icon-spiral-bg-dark-animated {
          animation: eclipseRotate 40s linear infinite;
        }
        
        .icon-spiral-bg-med-animated {
          animation: eclipseRotate 30s linear infinite reverse;
        }
        
        .icon-spiral-bg-light-animated {
          animation: eclipseRotate 25s linear infinite;
        }
